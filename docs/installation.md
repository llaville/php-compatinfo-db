...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/php-compatinfo-db" version="^6.25" copy="false" />
</phive>
```
...
```shell
composer require bartlett/php-compatinfo-db ^6.25
```
...
```shell
git clone -b 6.25 https://github.com/llaville/php-compatinfo-db.git
```
