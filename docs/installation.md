...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/php-compatinfo-db" version="^6.21" copy="false" />
</phive>
```
...
```shell
composer require bartlett/php-compatinfo-db ^6.21
```
...
```shell
git clone -b 6.21 https://github.com/llaville/php-compatinfo-db.git
```
