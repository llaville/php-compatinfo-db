...
<phive xmlns="https://phar.io/phive">
    <phar name="llaville/php-compatinfo-db" version="^6.26" copy="false" />
</phive>
```
...
```shell
composer require bartlett/php-compatinfo-db ^6.26
```
...
```shell
git clone -b 6.26 https://github.com/llaville/php-compatinfo-db.git
```
