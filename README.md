...
All the documentation is available on [website](https://llaville.github.io/php-compatinfo-db/6.31),
generated from the [docs](https://github.com/llaville/php-compatinfo-db/tree/6.31/docs) folder.
