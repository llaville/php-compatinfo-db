...
| Stable v6.30.x | [![Branch 6.30][Branch_630x-img]][Branch_630x] | [![Minimum PHP Version)][PHPVersion_630x-img]][PHPVersion_630x] | [![Stable Version 6.30][Packagist_630x-img]][Packagist_630x] | [![License 6.30][License_630x-img]][License_630x] | [![Documentation 6.30][Documentation_630x-img]][Documentation_630x] |
...
[Branch_630x-img]: https://img.shields.io/badge/branch-6.30-orange
[Branch_630x]: https://github.com/llaville/php-compatinfo-db/tree/6.30
[PHPVersion_630x-img]: https://img.shields.io/packagist/php-v/bartlett/php-compatinfo-db/6.30.0
[PHPVersion_630x]: https://www.php.net/supported-versions.php
[Packagist_630x-img]: https://img.shields.io/badge/packagist-v6.30.0-blue
[Packagist_630x]: https://packagist.org/packages/bartlett/php-compatinfo-db
[License_630x-img]: https://img.shields.io/packagist/l/bartlett/php-compatinfo-db
[License_630x]: https://github.com/llaville/php-compatinfo-db/blob/6.30/LICENSE
[Documentation_630x-img]: https://img.shields.io/badge/documentation-v6.30-green
[Documentation_630x]: https://github.com/llaville/php-compatinfo-db/tree/6.30/docs
...
## Version Compatibility
 ...
 | `6.0.x`  to `6.30.x` | `>= 8.1` and `< 8.6` | `7.0`, `7.1`, `7.2` |

## Documentation

All the documentation is available on [website](https://llaville.github.io/php-compatinfo-db/6.30),
generated from the [docs](https://github.com/llaville/php-compatinfo-db/tree/6.30/docs) folder.
